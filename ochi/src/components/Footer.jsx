...
const Footer = () => {
  return (
    <div className=' w-full h-screen flex relative overflow-hidden bg-zinc-900 p-10'>
        <div className=' flex flex-col h-full justify-between uppercase w-1/2 font-["Founders_Grotesk"] font-semibold'>
            <div className="heading">
                <h1 className='text-[7vw] leading-none -mb-5'>Eyes-</h1>
        ...
        <div className='w-1/2'>
            <h1 className='text-[6.5vw] leading-none -mb-5 font-["Founders_Grotesk"] font-semibold uppercase'>presentations</h1>

            {/* Socials */}
            <div className='dets flex flex-col font-[Neue_montreal] mt-10'>
                {["Facebook","Instagram","Twitter","Linkend"].map((item,index)=>{
                    return(
                        <a
                          key={index}
                          href="#"
                          className='inline-block text-xl relative transition-all duration-300 ease-out
                                     hover:-translate-y-0.5
                                     bg-gradient-to-r from-white to-white bg-no-repeat bg-left-bottom
                ...
                {["202-1965 W 4th Ave","Vancouver, Canada","30 Chukarina St","Lviv, Ukraine"].map((item,index)=>{
                    return(
                        <a
                          key={index}
                          href="#"
                          className='block text-xl relative transition-all duration-300 ease-out
                                     hover:-translate-y-0.5
                                     bg-gradient-to-r from-white to-white bg-no-repeat bg-left-bottom
                                     bg-[length:0%_1px] hover:bg-[length:100%_1px]'
                        >
            ...
            <div className='dets font-[Neue_montreal] mt-36'>
                <h1 className='block text-xl'>&copy; ochi design 2025. Legal Terms</h1>
            </div>
        </div>

        {/* Quick links */}
        <div className='dets font-[Neue_montreal] absolute bottom-50 right-10'>
            {["Home","Services","Our work","About us","Insights","Contact us"].map((item,index)=>{
                return(
                    <a
                      key={index}
                      href="#"
                      className=' text-xl block relative transition-all duration-300 ease-out
                                 hover:-translate-y-0.5
                                 bg-gradient-to-r from-white to-white bg-no-repeat bg-left-bottom
                                 bg-[length:0%_1px] hover:bg-[length:100%_1px]'
                    >
